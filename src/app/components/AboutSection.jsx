...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>
          BACHELOR OF TECHNOLOGY JECRC College 2018 – 2022 | Jaipur, India CGPA:
          7.53
          <li>
            HIGHER SECONDARY SCHOOL Prince School 2017 – 2018 | Sikar, India
            PERCENTAGE: 74.4%{" "}
          </li>
          <li>
            SECONDARY SCHOOL Prince School 2014 – 2015 | Sikar, india
            PERCENTAGE: 73.5%
          </li>
        </li>
      </ul>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>
          <b>Complete Web Design Course :</b> HTML, CSS, JAVASCRIPT and Jquery
          and Git
        </li>
        <li>
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React, Next.js, HTML, CSS, Bootstrap and
